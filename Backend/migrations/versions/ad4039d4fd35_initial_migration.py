...
Revision ID: ad4039d4fd35
Revises: 
Create Date: 2025-01-19 17:34:20.229747
...
def upgrade():
    ...
    op.create_table('Buses',
        ...
        sa.Column('busType', sa.Enum('AC Sleeper', 'Non-AC Seater', 'AC Seater', 'Luxury', name='bus_type_enum'), nullable=False),
    ...
    op.create_table('Bookings',
        ...
        sa.Column('status', sa.Enum('Confirmed', 'Cancelled', 'Pending', 'Completed', name='booking_status_enum'), nullable=True),
        sa.Column('paymentStatus', sa.Enum('Paid', 'Unpaid', name='payment_status_enum'), nullable=True),
