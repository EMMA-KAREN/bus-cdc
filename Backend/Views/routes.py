...
# ------ get a route by id.
# ------ get all routes (for front-end route selection)
@routes_bp.route('/routes/available', methods=['GET'])
...
def update_route(route_id):
    ...
    if route:
        ...
        db.session.commit()
        return jsonify({'message': 'Route updated successfully', 'route': route.to_json()})
